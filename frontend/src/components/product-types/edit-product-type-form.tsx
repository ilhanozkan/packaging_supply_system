  ...
  useEffect(() => {
    if (productTypes.length > 0) {
      ...
      if (foundProductType) {
        ...
        setFormData({
          name: foundProductType.name,
          description: foundProductType.description,
          imageUrl: foundProductType.imageUrl || "",
          isActive: foundProductType.isActive,
        });
      }
    }
    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Ürün türü için gerekli bilgileri güncelleyin
          </CardDescription>
        </CardHeader>
        <CardContent>
